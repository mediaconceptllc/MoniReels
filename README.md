...
Эх яриаг намсгахын оронд бүрэн **арилгаж** болно (Экспортын тохиргоо → «Эх
яриа: Арилгах»): worker Demucs-ээр экспортлох хэсгүүдийн эх яриаг хөгжим,
чимээнээс салгаж хасна — үзэгч монгол дуу, хөгжим, орчны чимээг л сонсоно.
Төлбөргүй ч worker-ийн CPU хугацаа авна; хэсэг бүрийг нэг л удаа салгаж R2-д
хадгална. Worker сервисийг `INSTALL_DUB=1`-ээр build хийсэн үед л
боломжтой ([DEPLOY.md](docs/DEPLOY.md#цэвэр-дубляж--эх-яриаг-арилгах-сонголт)).
...
| Эх яриа арилгах | [Demucs](https://github.com/facebookresearch/demucs) `htdemucs` — worker дээр, төлбөргүй | Worker сервист `INSTALL_DUB=1` |
