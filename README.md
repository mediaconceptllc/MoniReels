...
экспортолно. Англи хэлтэй видеог монгол руу орчуулж, хадмалыг монголоор
гаргана, хүсвэл орчуулгыг монгол дуугаар уншуулна.
...
Видео хуулах        хөтчөөс шууд R2 руу, сервер дундуур дамжихгүй
   ...
   ↓ transcribe     монгол яриа: duudlaga.dev эсвэл Scribe · англи яриа: ЗӨВХӨН Scribe
   ↓ translate      зөвхөн монголоос бусад хэлтэй видеонд: OpenRouter → монгол хадмал
   ↓ suggest        OpenRouter → богино видео + YouTube төлөвлөгөө (тоог продюсер сонгоно)
   ↓ export_all     ffmpeg → угсралт, хадмал, (сонголтоор) монгол дуу, R2 руу
```

Видеоны хэлийг хуулахдаа сонгоно (дараа нь засаж болно). Үзэгч үргэлж монгол
тул саналын гарчиг, дэгээ, тайлбар ямар ч видеонд монголоор бичигдэнэ; англи
видеоны хадмал анхдагчаар монгол орчуулгаар, Экспортын тохиргооноос эх хэлээр
нь ч гаргаж болно. Орчуулга эх текстийг ДАРДАГГҮЙ — мөр бүрийн хажууд
хадгалагдаж, гараар засагдана.

Монгол дуу нь төсөл бүрийн Экспортын тохиргоонд асдаг: экспортлох клипүүдэд
орсон мөрүүдийг л ElevenLabs-ээр уншуулж (тэмдэгтээр төлбөртэй), эх дууг
сонгосон түвшинд намсгаж, дээр нь тавина. Илтгэгч бүрд өөр хоолой сонгож
болно; сонгоогүй нь анхдагч хоолойгоор. Уншуулсан мөр бүр R2-д хадгалагдах
тул дахин экспортлоход ижил мөр дахин төлөгдөхгүй.
...
| Англи яриа таних (монголыг ч сонголтоор) | [ElevenLabs Scribe](https://elevenlabs.io/speech-to-text) | `ELEVENLABS_API_KEY` |
| Монгол дуу (TTS) | [ElevenLabs](https://elevenlabs.io) `eleven_v3` | `ELEVENLABS_API_KEY` + Тохиргоо хуудаснаас хоолой |
