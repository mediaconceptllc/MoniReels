...
> **duudlaga.dev-ийн API гэрээг шалгах шаардлагатай.** Клиент
> (`backend/app/stt/duudlaga_client.py`) нь OpenAI-нийцтэй нийтлэг
> хэлбэрээр бичигдсэн — албан ёсны баримтжуулалт хүрэлцээгүй орчинд
> бичигдсэн тул. Жинхэнэ зам өөр бол `DUUDLAGA_TRANSCRIBE_PATH`-аар засна,
> хариултын бүтэц өөр бол `_build_request` / `_parse_response` ХОЁРХОН
> функц өөрчлөгдөнө.
